          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-kumakichi-gold">🚗</span>
                <p className="text-white/80">駐車場完備（無料）</p>
              </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2">
                <span className="text-kumakichi-gold">🕐</span>
                <div>
                  <p className="text-white font-semibold">11:00 - 14:00 17:00 - 21:00</p>
                  <p className="text-yellow-300 text-xs mt-1">※火曜日は11:00 - 14:00</p>
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-white/60 text-sm">
                &copy; 2025 ラーメン熊きち All rights reserved.
              </p>
            </div>
          </div>
        </div>
